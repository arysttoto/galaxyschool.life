          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h1 className="h1">Welcome. Create or enter your Galaxy School Life account to proceed.</h1>
              </div>
              ...
              <div className="max-w-sm mx-auto">
                ...
                <div className="NOT-A-FORM">
                  ...
                  <div className="flex flex-wrap -mx-3">
                    <div className="w-full px-3">
                      <button onClick={() => signIn("google")} className="btn px-0 text-white bg-red-600 hover:bg-red-700 w-full relative flex items-center">
                        <svg className="w-4 h-4 fill-current text-white opacity-75 shrink-0 mx-4" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="text-gray-600 text-center mt-6">
                  If you already have an account still login here.
                </div>
              </div>
