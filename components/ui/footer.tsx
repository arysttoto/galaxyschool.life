    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <a href="#about" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Learn More</a>
              </li>
              <li className="mb-2">
                <a href="/suggestion-box" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Suggestion Box</a>
              </li>
              <li className="mb-2">
                <a href="/galaxy-life" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Galaxy Life</a>
              </li>
              <li className="mb-2">
                <a href="/student-council" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Student Council</a>
              </li>
            </ul>
          </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; GalaxySchool.Life All rights reserved.</div>
